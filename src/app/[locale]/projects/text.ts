...
const PROJECT_PAGE: ProjectPage = {
  ...
  projects: [
    {
      name: 'Portfolio: My Personal Showtime of Talent',
    ...
    {
      name: 'NPM RUN Wild: A Platform for Full-Stack Education',
    ...
    {
      name: 'ROCCO.CODE: My Personal NeoVim Code Editor',
    ...
    {
      name: 'RESQ: A Mobile App for Pet Adoptions',
    ...
    {
      name: 'MINDMAPPER: An App to Care for Mental Health',
