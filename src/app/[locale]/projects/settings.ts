...
const PROJECT_PAGE: ProjectPage = {
  ...
  projects: {
    portfolio: {
      ...
      stack: ['typescript', 'react', 'nextjs', 'sass', 'mongo', 'redis', 'openai', 'vercel', 'docker'],
      repoHref: 'https://github.com/adrihle/portfolio',
      infoHref: "mailto:info+portfolio@adrilopez.dev?subject=I%20Would%20Like%20to%20Talk%20About%20the%20Portfolio%20Project",
    ...
    roccocode: {
      ...
      aspectRatio: '1.4 / 1',
      repoHref: 'https://github.com/adrihle/roccocode',
      infoHref: "mailto:info+portfolio@adrilopez.dev?subject=I%20Would%20Like%20to%20Talk%20About%20the%Roccocode%20Project",
      background: 'linear-gradient(to bottom, rgba(34, 83, 201, 1) 50%, rgba(34, 83, 201, 0.8) 60%, rgba(34, 83, 201, 0) 100%)',
    },
    npmrunwild: {
      name: 'NPM RUN Wild',
