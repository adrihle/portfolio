...
const getBrandIconUrl = ({ icon, color }: Omit<BrandProps, 'size'>) => {
  ...
  if (LOCAL_STACK_ICONS[icon as keyof typeof LOCAL_STACK_ICONS]) return LOCAL_STACK_ICONS[icon as keyof typeof LOCAL_STACK_ICONS];
